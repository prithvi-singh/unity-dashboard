...
// and the background warm loop. `windowMonths` (null = full fetch) scopes
// FULL syncs to recent records only — Zoho reports are sorted oldest-first
// by default and hit the fetch cap before reaching current data.
//
...
const REPORTS = {
  patients:     { linkName: 'All_Contacts',            ttlMs: 6 * 60 * 60 * 1000, windowMonths: null },
  invoices:     { linkName: 'All_Invoices',            ttlMs: 4 * 60 * 60 * 1000, windowMonths: 12   },
  appointments: { linkName: 'All_Appointmenta_Report', ttlMs: 2 * 60 * 60 * 1000, windowMonths: 12   },
  receipts:     { linkName: 'All_Receipts1_Report',    ttlMs: 4 * 60 * 60 * 1000, windowMonths: 12   },
  cycles:       { linkName: 'All_Cycles',              ttlMs: 6 * 60 * 60 * 1000, windowMonths: 12   },
  leads:        { linkName: 'All_Leads',               ttlMs: 2 * 60 * 60 * 1000, windowMonths: null },
  'crm-leads':  { linkName: 'CRM_Lead_Report',         ttlMs: 2 * 60 * 60 * 1000, windowMonths: null },
};
